...
QT_MOC_LITERAL(1, 10, 8), // "MySingal"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "SubWidget\0MySingal\0"
};
...
void SubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->MySingal((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubWidget::MySingal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SubWidget::MySingal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SubWidget::MySingal(int _t1, QString _t2)
{
